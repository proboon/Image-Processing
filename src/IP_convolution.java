 ...
 * @author Meadow
 */
public class IP_convolution extends project_IP {
    public void convolutionwork(String name,String path,int width,int height) throws IOException {
...
//                {1, 1, 1}};
        ...
        FileOutputStream fout = new FileOutputStream("Convolution_"+name);
